...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Love in Action'>;
    ...
    timelineTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Our Journey'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAlertAlert extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['announcement', 'info', 'warning', 'success']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCauseCause extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Fundraising causes and campaigns';
    displayName: 'Cause';
    pluralName: 'causes';
    singularName: 'cause';
  };
...
export interface ApiChildChild extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currentGrade: Schema.Attribute.String;
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    joinedSponsorshipProgram: Schema.Attribute.Date;
    liaId: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiGalleryGallery extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['event', 'children']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Main homepage content management';
  ...
  attributes: {
    ...
    heroTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Changing lives one child at a time!'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Organization services and programs';
    displayName: 'Service';
    pluralName: 'services';
